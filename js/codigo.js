...
function generarTarjetasAleatorias(){
	for(let i=0; i<parseInt(longitud/2); i++){
		let eliminado = iconos[i]

		let llave = llaveAleatoria()
		let llave2 = llaveAleatoria()
...
const longitud = tarjetas.length
...
const iconos = [
	{nombre: 'icon-html-five', 	numero: 1},
	{nombre: 'icon-google', 	numero: 2},
	{nombre: 'icon-twitter', 	numero: 3},
	{nombre: 'icon-youtube', 	numero: 4},
	{nombre: 'icon-tux', 		numero: 5},
	{nombre: 'icon-facebook', 	numero: 6},
	{nombre: 'icon-appleinc', 	numero: 7},
	{nombre: 'icon-android', 	numero: 8},
	{nombre: 'icon-windows', 	numero: 9},
	{nombre: 'icon-chrome', 	numero: 10},
